...
_Source pages: 189–213 | Depth: 2_
...
> **[Screenshot: OpenAI Connection & Credential Aliases form]**
> ServiceNow form record for the OpenAI Generative AI Spoke connection alias. An info banner reads: "This record is in the OpenAI Generative AI Spoke application, but Global is the current application. To edit this record click here." Form fields: Name: "OpenAI", ID: "sn_openai.OpenAI", Application: "OpenAI Generative AI Spoke" with an info icon, Type: "Connection and Credential", Connection type: "HTTP", Support Multiple Active Connections: (unchecked), Default Retry Policy: (blank), Configuration Template: "OpenAI Template". A "Related Links" section shows a blue "Create New Connection & Credential" link with an arrow annotation pointing to it. Step 4 text below: "In the API key field, enter the API key."
