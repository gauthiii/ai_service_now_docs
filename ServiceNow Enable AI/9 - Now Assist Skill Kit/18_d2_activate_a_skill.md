...
> **[Screenshot: Now Assist Admin – Activate Skill Card (page 41)]**
>
> White card area titled **"All available Child Incident Summarization skills"** with sub-text "Set up and configure each skill. A skill delivers generative AI functionality."
>
> A single skill card below (white rounded rectangle, bordered):
> - Grey status badge: **"Draft"**
> - Bold title: **"Child Incident Summary"**
> - Grey sub-text: "Summary of child incidents"
> - Teal outlined button: **"Activate skill"**
